...
{
	partial class AccessDataSource: Tortuga.Chain.DataSources.IRootDataSource
	{

		private bool __TraitsRegistered;

		// These fields and/or properties hold the traits. They should not be referenced directly.
		private Traits.RootDataSourceTrait<Tortuga.Chain.Access.AccessTransactionalDataSource, Tortuga.Chain.Access.AccessOpenDataSource, System.Data.OleDb.OleDbConnection, System.Data.OleDb.OleDbTransaction, System.Data.OleDb.OleDbCommand> ___Trait0 = new();
		private Traits.RootDataSourceTrait<Tortuga.Chain.Access.AccessTransactionalDataSource, Tortuga.Chain.Access.AccessOpenDataSource, System.Data.OleDb.OleDbConnection, System.Data.OleDb.OleDbTransaction, System.Data.OleDb.OleDbCommand> __Trait0
		{
			get
			{
		...
		// Exposing trait Traits.RootDataSourceTrait<Tortuga.Chain.Access.AccessTransactionalDataSource, Tortuga.Chain.Access.AccessOpenDataSource, System.Data.OleDb.OleDbConnection, System.Data.OleDb.OleDbTransaction, System.Data.OleDb.OleDbCommand>
		...
		public  Tortuga.Chain.Access.AccessTransactionalDataSource BeginTransaction()
		{
		...
		/// <returns></returns>
		/// <remarks>The caller of this method is responsible for closing the transaction.</remarks>
		public  Tortuga.Chain.Access.AccessTransactionalDataSource BeginTransaction(System.Nullable<System.Data.IsolationLevel> isolationLevel = default, System.Boolean forwardEvents = true)
		{
		...
		/// <returns></returns>
		/// <remarks>The caller of this method is responsible for closing the transaction.</remarks>
		public  System.Threading.Tasks.Task<Tortuga.Chain.Access.AccessTransactionalDataSource> BeginTransactionAsync(System.Nullable<System.Data.IsolationLevel> isolationLevel = default, System.Boolean forwardEvents = true, System.Threading.CancellationToken cancellationToken = default)
		{
		...
		/// <returns></returns>
		/// <remarks>The caller of this method is responsible for closing the transaction.</remarks>
		public  System.Threading.Tasks.Task<Tortuga.Chain.Access.AccessTransactionalDataSource> BeginTransactionAsync()
		{
		...
		public  Tortuga.Chain.Access.AccessOpenDataSource CreateOpenDataSource(System.Data.OleDb.OleDbConnection connection, System.Data.OleDb.OleDbTransaction? transaction = default)
		{
		...
		/// </summary>
		/// <remarks>WARNING: The caller of this method is responsible for closing the connection.</remarks>
		public  Tortuga.Chain.Access.AccessOpenDataSource CreateOpenDataSource()
		{
		...
		private partial System.Threading.Tasks.Task<System.Data.OleDb.OleDbConnection> OnCreateConnectionAsync(System.Threading.CancellationToken cancellationToken );
