...
{
	partial class SQLiteOpenDataSource: Tortuga.Chain.DataSources.IOpenDataSource
	{

		private bool __TraitsRegistered;

		// These fields and/or properties hold the traits. They should not be referenced directly.
		private Traits.OpenDataSourceTrait<Tortuga.Chain.SQLiteDataSource, Tortuga.Chain.SQLite.SQLiteOpenDataSource, System.Data.SQLite.SQLiteConnection, System.Data.SQLite.SQLiteTransaction, System.Data.SQLite.SQLiteCommand, Tortuga.Chain.SQLite.SQLiteMetadataCache> ___Trait0 = new();
		private Traits.OpenDataSourceTrait<Tortuga.Chain.SQLiteDataSource, Tortuga.Chain.SQLite.SQLiteOpenDataSource, System.Data.SQLite.SQLiteConnection, System.Data.SQLite.SQLiteTransaction, System.Data.SQLite.SQLiteCommand, Tortuga.Chain.SQLite.SQLiteMetadataCache> __Trait0
		{
			get
			{
		...
		// Exposing trait Traits.OpenDataSourceTrait<Tortuga.Chain.SQLiteDataSource, Tortuga.Chain.SQLite.SQLiteOpenDataSource, System.Data.SQLite.SQLiteConnection, System.Data.SQLite.SQLiteTransaction, System.Data.SQLite.SQLiteCommand, Tortuga.Chain.SQLite.SQLiteMetadataCache>
		...
		/// <returns></returns>
		public Tortuga.Chain.SQLite.SQLiteOpenDataSource WithRules(params Tortuga.Chain.AuditRules.AuditRule[] additionalRules)
		{
		...
		/// <param name="additionalRules">The additional rules.</param>
		/// <returns></returns>
		public Tortuga.Chain.SQLite.SQLiteOpenDataSource WithRules(System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule> additionalRules)
		{
			return __Trait0.WithRules(additionalRules);
		}
		...
		/// </remarks>
		public Tortuga.Chain.SQLite.SQLiteOpenDataSource WithUser(System.Object? userValue)
		{
			return __Trait0.WithUser(userValue);
		}

		private partial Tortuga.Chain.SQLite.SQLiteOpenDataSource OnOverride(System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule>? additionalRules, System.Object? userValue );
