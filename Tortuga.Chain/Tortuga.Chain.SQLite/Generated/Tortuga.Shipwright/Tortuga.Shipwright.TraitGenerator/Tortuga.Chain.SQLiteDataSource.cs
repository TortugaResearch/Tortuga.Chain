...
{
	partial class SQLiteDataSource: Tortuga.Chain.DataSources.IRootDataSource, Traits.IHasExtensionCache
	{

		private bool __TraitsRegistered;

		// These fields and/or properties hold the traits. They should not be referenced directly.
		private Traits.RootDataSourceTrait<Tortuga.Chain.SQLiteDataSource, Tortuga.Chain.SQLite.SQLiteTransactionalDataSource, Tortuga.Chain.SQLite.SQLiteOpenDataSource, System.Data.SQLite.SQLiteConnection, System.Data.SQLite.SQLiteTransaction, System.Data.SQLite.SQLiteCommand, System.Data.SQLite.SQLiteConnectionStringBuilder> ___Trait0 = new();
		private Traits.RootDataSourceTrait<Tortuga.Chain.SQLiteDataSource, Tortuga.Chain.SQLite.SQLiteTransactionalDataSource, Tortuga.Chain.SQLite.SQLiteOpenDataSource, System.Data.SQLite.SQLiteConnection, System.Data.SQLite.SQLiteTransaction, System.Data.SQLite.SQLiteCommand, System.Data.SQLite.SQLiteConnectionStringBuilder> __Trait0
		{
			get
			{
		...
		public Tortuga.Chain.SQLite.SQLiteTransactionalDataSource BeginTransaction()
		{
		...
		/// <returns></returns>
		/// <remarks>The caller of this method is responsible for closing the transaction.</remarks>
		public Tortuga.Chain.SQLite.SQLiteTransactionalDataSource BeginTransaction(System.Nullable<System.Data.IsolationLevel> isolationLevel = default, System.Boolean forwardEvents = true)
		{
		...
		/// <returns></returns>
		/// <remarks>The caller of this method is responsible for closing the transaction.</remarks>
		public System.Threading.Tasks.Task<Tortuga.Chain.SQLite.SQLiteTransactionalDataSource> BeginTransactionAsync(System.Nullable<System.Data.IsolationLevel> isolationLevel = default, System.Boolean forwardEvents = true, System.Threading.CancellationToken cancellationToken = default)
		{
		...
		/// <returns></returns>
		/// <remarks>The caller of this method is responsible for closing the transaction.</remarks>
		public System.Threading.Tasks.Task<Tortuga.Chain.SQLite.SQLiteTransactionalDataSource> BeginTransactionAsync()
		{
		...
		public System.Data.SQLite.SQLiteConnection CreateConnection()
		{
		...
		/// </remarks>
		public System.Threading.Tasks.Task<System.Data.SQLite.SQLiteConnection> CreateConnectionAsync(System.Threading.CancellationToken cancellationToken = default)
		{
		...
		public Tortuga.Chain.SQLite.SQLiteOpenDataSource CreateOpenDataSource(System.Data.SQLite.SQLiteConnection connection, System.Data.SQLite.SQLiteTransaction? transaction = default)
		{
		...
		/// </summary>
		private   System.Data.SQLite.SQLiteConnectionStringBuilder m_ConnectionBuilder
		{
		...
		/// <returns></returns>
		public Tortuga.Chain.SQLiteDataSource WithCache(Tortuga.Chain.Core.ICacheAdapter cache)
		{
		...
		/// <returns></returns>
		public Tortuga.Chain.SQLiteDataSource WithRules(params Tortuga.Chain.AuditRules.AuditRule[] additionalRules)
		{
		...
		/// <param name="additionalRules">The additional rules.</param>
		/// <returns></returns>
		public Tortuga.Chain.SQLiteDataSource WithRules(System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule> additionalRules)
		{
			return __Trait0.WithRules(additionalRules);
		}
		...
		/// </remarks>
		public Tortuga.Chain.SQLiteDataSource WithUser(System.Object? userValue)
		{
		...
		private partial System.Threading.Tasks.Task<Tortuga.Chain.SQLite.SQLiteTransactionalDataSource> OnBeginTransactionAsync(System.Nullable<System.Data.IsolationLevel> isolationLevel, System.Boolean forwardEvents, System.Threading.CancellationToken cancellationToken );

		private partial Tortuga.Chain.SQLiteDataSource OnCloneWithOverrides(Tortuga.Chain.Core.ICacheAdapter? cache, System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule>? additionalRules, System.Object? userValue );

		private partial System.Data.SQLite.SQLiteConnection OnCreateConnection( );

		private partial System.Threading.Tasks.Task<System.Data.SQLite.SQLiteConnection> OnCreateConnectionAsync(System.Threading.CancellationToken cancellationToken );
