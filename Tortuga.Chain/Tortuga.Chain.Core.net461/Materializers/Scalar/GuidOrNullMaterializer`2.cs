...
namespace Tortuga.Chain.Materializers
{
    ...
    public class GuidOrNullMaterializer<TCommandType, TParameterType> : SingleColumnMaterializer<TCommandType, TParameterType, Guid?> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public GuidOrNullMaterializer(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
