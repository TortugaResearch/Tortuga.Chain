...
namespace Tortuga.Chain.Materializers
{
    ...
    public class StringMaterializer<TCommandType, TParameterType> : SingleColumnMaterializer<TCommandType, TParameterType, string> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public StringMaterializer(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
