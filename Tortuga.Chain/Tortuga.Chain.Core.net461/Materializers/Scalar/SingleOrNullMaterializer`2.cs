...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class SingleOrNullMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, float?> where TCommand : DbCommand
        where TParameter : DbParameter
    {
        ...
        public SingleOrNullMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string columnName = null)
