...
namespace Tortuga.Chain.Materializers
{
    ...
    public class SingleOrNullMaterializer<TCommandType, TParameterType> : SingleColumnMaterializer<TCommandType, TParameterType, float?> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public SingleOrNullMaterializer(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
