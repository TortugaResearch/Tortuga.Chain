...
namespace Tortuga.Chain.Materializers
{
    ...
    public class Int32Materializer<TCommandType, TParameterType> : SingleColumnMaterializer<TCommandType, TParameterType, int> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public Int32Materializer(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
