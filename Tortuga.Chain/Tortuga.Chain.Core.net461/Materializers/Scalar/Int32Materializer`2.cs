...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class Int32Materializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, int> where TCommand : DbCommand
        where TParameter : DbParameter
    {
        ...
        public Int32Materializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string columnName = null)
