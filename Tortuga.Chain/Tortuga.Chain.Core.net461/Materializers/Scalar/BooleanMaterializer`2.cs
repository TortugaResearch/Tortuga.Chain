...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class BooleanMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, bool>
        ...
        where TParameter : DbParameter
    {
        ...
        public BooleanMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string columnName = null)
