...
namespace Tortuga.Chain.Materializers
{
    ...
    public class Int32OrNullMaterializer<TCommandType, TParameterType> : SingleColumnMaterializer<TCommandType, TParameterType, int?> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public Int32OrNullMaterializer(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
