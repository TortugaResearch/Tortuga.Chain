...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class DoubleOrNullMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, double?> where TCommand : DbCommand
        where TParameter : DbParameter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleOrNullMaterializer{TCommand, TParameter}"/> class.
        /// </summary>
        /// <param name="commandBuilder">The command builder.</param>
        /// <param name="columnName">Name of the desired column.</param>
        public DoubleOrNullMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string columnName = null)
