...
namespace Tortuga.Chain.MySql.CommandBuilders
{
    ...
    /// </summary>
    internal sealed class MySqlInsertOrUpdateObject<TArgument> : UpsertDbCommandBuilder<MySqlCommand, MySqlParameter, TArgument>
        where TArgument : class
    {
        ...
        /// <returns></returns>
        public override UpsertDbCommandBuilder<MySqlCommand, MySqlParameter, TArgument> MatchOn(params string[] columnNames)
        {
