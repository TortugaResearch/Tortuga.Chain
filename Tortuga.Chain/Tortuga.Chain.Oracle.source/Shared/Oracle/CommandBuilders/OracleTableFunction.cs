...
{
    /// <summary>
    /// Class OracleTableFunction.
    /// </summary>
    public class OracleTableFunction : TableDbCommandBuilder<OracleCommand, OracleParameter, OracleLimitOption>
    {

        readonly TableFunctionMetadata<OracleObjectName, OracleDbType> m_Table;
        ...
        public OracleTableFunction(OracleDataSourceBase dataSource, OracleObjectName tableFunctionName, object functionArgumentValue) : base(dataSource)
        {
            if (dataSource == null)
