...
{
	partial class OleDbSqlServerDataSource: Tortuga.Chain.DataSources.IRootDataSource, Traits.IHasExtensionCache
	{
		...
		/// <returns></returns>
		public Tortuga.Chain.OleDbSqlServerDataSource WithCache(Tortuga.Chain.Core.ICacheAdapter cache)
		{
		...
		/// <returns></returns>
		public Tortuga.Chain.OleDbSqlServerDataSource WithRules(params Tortuga.Chain.AuditRules.AuditRule[] additionalRules)
		{
		...
		/// <param name="additionalRules">The additional rules.</param>
		/// <returns></returns>
		public Tortuga.Chain.OleDbSqlServerDataSource WithRules(System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule> additionalRules)
		{
			return __Trait0.WithRules(additionalRules);
		}
		...
		/// </remarks>
		public Tortuga.Chain.OleDbSqlServerDataSource WithUser(System.Object? userValue)
		{
			return __Trait0.WithUser(userValue);
		}

		private partial Tortuga.Chain.SqlServer.OleDbSqlServerTransactionalDataSource OnBeginTransaction(System.Nullable<System.Data.IsolationLevel> isolationLevel, System.Boolean forwardEvents );

		private partial System.Threading.Tasks.Task<Tortuga.Chain.SqlServer.OleDbSqlServerTransactionalDataSource> OnBeginTransactionAsync(System.Nullable<System.Data.IsolationLevel> isolationLevel, System.Boolean forwardEvents, System.Threading.CancellationToken cancellationToken );

		private partial Tortuga.Chain.OleDbSqlServerDataSource OnCloneWithOverrides(Tortuga.Chain.Core.ICacheAdapter? cache, System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule>? additionalRules, System.Object? userValue );
		...
		private partial Tortuga.Chain.SqlServer.OleDbSqlServerOpenDataSource OnCreateOpenDataSource(System.Data.OleDb.OleDbConnection connection, System.Data.OleDb.OleDbTransaction? transaction );
