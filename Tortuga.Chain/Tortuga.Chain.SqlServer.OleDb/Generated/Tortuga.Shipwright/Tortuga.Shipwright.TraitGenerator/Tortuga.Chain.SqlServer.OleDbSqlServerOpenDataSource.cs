...
{
	partial class OleDbSqlServerOpenDataSource: Tortuga.Chain.DataSources.IOpenDataSource
	{

		private bool __TraitsRegistered;

		// These fields and/or properties hold the traits. They should not be referenced directly.
		private Traits.OpenDataSourceTrait<Tortuga.Chain.OleDbSqlServerDataSource, Tortuga.Chain.SqlServer.OleDbSqlServerOpenDataSource, System.Data.OleDb.OleDbConnection, System.Data.OleDb.OleDbTransaction, System.Data.OleDb.OleDbCommand, Tortuga.Chain.SqlServer.OleDbSqlServerMetadataCache> ___Trait0 = new();
		private Traits.OpenDataSourceTrait<Tortuga.Chain.OleDbSqlServerDataSource, Tortuga.Chain.SqlServer.OleDbSqlServerOpenDataSource, System.Data.OleDb.OleDbConnection, System.Data.OleDb.OleDbTransaction, System.Data.OleDb.OleDbCommand, Tortuga.Chain.SqlServer.OleDbSqlServerMetadataCache> __Trait0
		{
			get
			{
		...
		// Exposing trait Traits.OpenDataSourceTrait<Tortuga.Chain.OleDbSqlServerDataSource, Tortuga.Chain.SqlServer.OleDbSqlServerOpenDataSource, System.Data.OleDb.OleDbConnection, System.Data.OleDb.OleDbTransaction, System.Data.OleDb.OleDbCommand, Tortuga.Chain.SqlServer.OleDbSqlServerMetadataCache>
		...
		/// <returns></returns>
		public Tortuga.Chain.SqlServer.OleDbSqlServerOpenDataSource WithRules(params Tortuga.Chain.AuditRules.AuditRule[] additionalRules)
		{
		...
		/// <param name="additionalRules">The additional rules.</param>
		/// <returns></returns>
		public Tortuga.Chain.SqlServer.OleDbSqlServerOpenDataSource WithRules(System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule> additionalRules)
		{
			return __Trait0.WithRules(additionalRules);
		}
		...
		/// </remarks>
		public Tortuga.Chain.SqlServer.OleDbSqlServerOpenDataSource WithUser(System.Object? userValue)
		{
			return __Trait0.WithUser(userValue);
		}

		private partial Tortuga.Chain.SqlServer.OleDbSqlServerOpenDataSource OnOverride(System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule>? additionalRules, System.Object? userValue );
