...
{
    /// <summary>
    /// Formats the result set as a list of integers.
    /// </summary>
    /// <typeparam name="TCommandType">The type of the t command type.</typeparam>
    /// <typeparam name="TParameterType">The type of the t parameter type.</typeparam>
    public class Int32ListMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<int>> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public Int32ListMaterializer(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, ListOptions listOptions, string columnName = null)
        ...
        /// </summary>
        /// <returns></returns>
        public override List<int> Execute(object state = null)
        {
        ...
        /// <returns></returns>
        public override async Task<List<int>> ExecuteAsync(CancellationToken cancellationToken, object state = null)
        {
            var result = new List<int>();
