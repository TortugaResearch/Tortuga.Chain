...
namespace Tortuga.Chain.Materializers
{
    ...
    public class DateTimeOffsetListMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<DateTimeOffset>> where TCommandType : DbCommand
