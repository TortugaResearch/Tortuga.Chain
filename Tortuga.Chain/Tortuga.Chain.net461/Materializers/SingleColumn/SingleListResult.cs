...
namespace Tortuga.Chain.Materializers
{
    ...
    public class SingleListMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<float>> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public SingleListMaterializer(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, ListOptions listOptions, string columnName = null)
