...
namespace Tortuga.Chain.Materializers
{
    ...
    public class Int32ListMaterializer<TCommandType, TParameterType> : SingleColumnMaterializer<TCommandType, TParameterType, List<int>> where TCommandType : DbCommand
