...
namespace Tortuga.Chain.Materializers
{
    ...
    public class StringListMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<string>> where TCommandType : DbCommand
