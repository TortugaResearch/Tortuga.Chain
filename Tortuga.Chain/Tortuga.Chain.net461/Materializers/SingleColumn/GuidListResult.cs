...
namespace Tortuga.Chain.Materializers
{
    ...
    public class GuidListMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<Guid>> where TCommandType : DbCommand
