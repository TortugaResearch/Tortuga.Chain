...
namespace Tortuga.Chain.Materializers
{
    ...
    public class DateTimeListMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<DateTime>> where TCommandType : DbCommand
