...
namespace Tortuga.Chain.Materializers
{
    ...
    public class SingleListMaterializer<TCommandType, TParameterType> : SingleColumnMaterializer<TCommandType, TParameterType, List<float>> where TCommandType : DbCommand
