...
namespace Tortuga.Chain.Materializers
{
    ...
    public class Int64ListMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<long>> where TCommandType : DbCommand
