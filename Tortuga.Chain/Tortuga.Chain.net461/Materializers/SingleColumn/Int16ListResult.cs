...
namespace Tortuga.Chain.Materializers
{
    ...
    public class Int16ListMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<short>> where TCommandType : DbCommand
