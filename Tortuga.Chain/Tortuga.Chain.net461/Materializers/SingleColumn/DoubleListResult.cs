...
namespace Tortuga.Chain.Materializers
{
    ...
    public class DoubleListMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<double>> where TCommandType : DbCommand
