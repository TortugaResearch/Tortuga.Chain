...
namespace Tortuga.Chain.Materializers
{
    ...
    public class Int64OrNullMaterializer<TTCommandType, TParameterType> : SingleColumnFormatter<TTCommandType, TParameterType, long?> where TTCommandType : DbCommand
