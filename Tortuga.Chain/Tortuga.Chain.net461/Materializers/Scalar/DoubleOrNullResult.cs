...
namespace Tortuga.Chain.Materializers
{
    ...
    public class DoubleOrNullMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, double?> where TCommandType : DbCommand
