...
namespace Tortuga.Chain.Materializers
{
    ...
    public class TimeSpanOrNullMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, TimeSpan?> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public TimeSpanOrNullMaterializer(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
