...
namespace Tortuga.Chain.Materializers
{
    ...
    public class DateTimeOffsetMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, DateTimeOffset> where TCommandType : DbCommand
