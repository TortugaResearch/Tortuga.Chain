...
namespace Tortuga.Chain.Materializers
{
    ...
    public class DateTimeOffsetOrNullMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, DateTimeOffset?> where TCommandType : DbCommand
