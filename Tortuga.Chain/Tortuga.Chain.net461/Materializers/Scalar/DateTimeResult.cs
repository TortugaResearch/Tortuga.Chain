...
namespace Tortuga.Chain.Materializers
{
    ...
    public class DateTimeMaterializer<TTCommandType, TParameterType> : SingleColumnFormatter<TTCommandType, TParameterType, DateTime> where TTCommandType : DbCommand
