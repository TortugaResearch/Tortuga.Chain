...
namespace Tortuga.Chain.Materializers
{
    ...
    public class SingleOrNullMaterializer<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, float?> where TCommandType : DbCommand
