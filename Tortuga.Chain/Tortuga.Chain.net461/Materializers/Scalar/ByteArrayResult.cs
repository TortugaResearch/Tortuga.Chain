...
{
    /// <summary>
    /// Formats the result set as a byte array.
    /// </summary>
    /// <typeparam name="TTCommandType">The type of the tt command type.</typeparam>
    /// <typeparam name="TParameterType">The type of the t parameter type.</typeparam>
    public class ByteArrayMaterializer<TTCommandType, TParameterType> : SingleColumnFormatter<TTCommandType, TParameterType, byte[]>
        where TTCommandType : DbCommand
        where TParameterType : DbParameter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ByteArrayMaterializer{TTCommandType, TParameterType}"/> class.
        /// </summary>
        /// <param name="commandBuilder">The command builder.</param>
        /// <param name="columnName">Name of the desired column.</param>
        public ByteArrayMaterializer(DbCommandBuilder<TTCommandType, TParameterType> commandBuilder, string columnName = null)
