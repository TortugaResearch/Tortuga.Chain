...
namespace Tortuga.Chain.Materializers
{
    ...
    public class RowMaterializer<TCommandType, TParameterType> : Formatter<TCommandType, TParameterType, IReadOnlyDictionary<string, object>> where TCommandType : DbCommand
