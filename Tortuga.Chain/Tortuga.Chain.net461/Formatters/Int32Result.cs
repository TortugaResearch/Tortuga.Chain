...
namespace Tortuga.Chain.Formatters
{
    ...
    public class Int32Result<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, int> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public Int32Result(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
