...
namespace Tortuga.Chain.Formatters
{
    ...
    public class TimeSpanOrNullResult<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, TimeSpan?> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public TimeSpanOrNullResult(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
