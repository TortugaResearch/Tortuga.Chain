...
{
    /// <summary>
    /// Formats the result set as a TimeSpan.
    /// </summary>
    /// <typeparam name="TCommandType">The type of the t command type.</typeparam>
    /// <typeparam name="TParameterType">The type of the t parameter type.</typeparam>
    public class TimeSpanResult<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, TimeSpan> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSpanResult{TCommandType, TParameterType}"/> class.
        /// </summary>
        /// <param name="commandBuilder">The command builder.</param>
        /// <param name="columnName">Name of the desired column.</param>
        public TimeSpanResult(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
