...
namespace Tortuga.Chain.Formatters
{
    ...
    public class DoubleListResult<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<double>> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleListResult{TCommandType, TParameterType}"/> class.
        /// </summary>
        /// <param name="commandBuilder">The command builder.</param>
        /// <param name="listOptions">The list options.</param>
        /// <param name="columnName">Name of the desired column.</param>
        public DoubleListResult(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, ListOptions listOptions, string columnName = null)
