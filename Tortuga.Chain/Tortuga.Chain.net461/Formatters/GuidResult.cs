...
namespace Tortuga.Chain.Formatters
{
    ...
    public class GuidResult<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, Guid> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public GuidResult(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
