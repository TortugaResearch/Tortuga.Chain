...
{
    /// <summary>
    /// Formats the result set as a TableSet.
    /// </summary>
    /// <typeparam name="TCommandType">The type of the t command type.</typeparam>
    /// <typeparam name="TParameterType">The type of the t parameter type.</typeparam>
    public class TableSetResult<TCommandType, TParameterType> : Formatter<TCommandType, TParameterType, TableSet> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public TableSetResult(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string[] tableNames)
            : base(commandBuilder)
        {
