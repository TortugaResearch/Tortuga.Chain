...
namespace Tortuga.Chain.Formatters
{
    ...
    public class BooleanListResult<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, List<bool>>
        ...
        where TParameterType : DbParameter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanListResult{TCommandType, TParameterType}"/> class.
        /// </summary>
        /// <param name="commandBuilder">The command builder.</param>
        /// <param name="listOptions">The list options.</param>
        /// <param name="columnName">Name of the desired column.</param>
        public BooleanListResult(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, ListOptions listOptions, string columnName = null)
