...
namespace Tortuga.Chain.Formatters
{
    ...
    public class Int16Result<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, short> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public Int16Result(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
