...
namespace Tortuga.Chain.Formatters
{
    ...
    public class ByteArrayResult<TTCommandType, TParameterType> : SingleColumnFormatter<TTCommandType, TParameterType, byte[]>
        where TTCommandType : DbCommand
        where TParameterType : DbParameter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ByteArrayResult{TTCommandType, TParameterType}"/> class.
        /// </summary>
        /// <param name="commandBuilder">The command builder.</param>
        /// <param name="columnName">Name of the desired column.</param>
        public ByteArrayResult(DbCommandBuilder<TTCommandType, TParameterType> commandBuilder, string columnName = null)
