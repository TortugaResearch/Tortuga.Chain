...
namespace Tortuga.Chain.Formatters
{
    ...
    public class DecimalResult<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, decimal> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecimalResult{TCommandType, TParameterType}"/> class.
        /// </summary>
        /// <param name="commandBuilder">The command builder.</param>
        /// <param name="columnName">Name of the desired column.</param>
        public DecimalResult(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
