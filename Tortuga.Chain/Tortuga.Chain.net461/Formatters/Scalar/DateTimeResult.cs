...
namespace Tortuga.Chain.Formatters
{
    ...
    public class DateTimeResult<TTCommandType, TParameterType> : SingleColumnFormatter<TTCommandType, TParameterType, DateTime> where TTCommandType : DbCommand
        where TParameterType : DbParameter

    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateTimeResult{TTCommandType, TParameterType}"/> class.
        /// </summary>
        /// <param name="commandBuilder">The command builder.</param>
        /// <param name="columnName">Name of the desired column.</param>
        public DateTimeResult(DbCommandBuilder<TTCommandType, TParameterType> commandBuilder, string columnName = null)
