...
namespace Tortuga.Chain.Formatters
{
    ...
    public class SingleResult<TCommandType, TParameterType> : SingleColumnFormatter<TCommandType, TParameterType, float> where TCommandType : DbCommand
        where TParameterType : DbParameter
    {
        ...
        public SingleResult(DbCommandBuilder<TCommandType, TParameterType> commandBuilder, string columnName = null)
