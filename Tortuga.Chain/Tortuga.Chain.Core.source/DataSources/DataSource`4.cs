...
namespace Tortuga.Chain.DataSources
{
        ...
        where TParameter : DbParameter
    {
        ...
        protected internal abstract void Execute(ExecutionToken<TCommand, TParameter> executionToken, CommandImplementation<TCommand> implementation, object state);
        ...
        protected internal abstract Task ExecuteAsync(ExecutionToken<TCommand, TParameter> executionToken, CommandImplementationAsync<TCommand> implementation, CancellationToken cancellationToken, object state);
        ...
        void ICommandDataSource<TCommand, TParameter>.Execute(ExecutionToken<TCommand, TParameter> executionToken, CommandImplementation<TCommand> implementation, object state)
        {
            Execute(executionToken, implementation, state);
        }

        Task ICommandDataSource<TCommand, TParameter>.ExecuteAsync(ExecutionToken<TCommand, TParameter> executionToken, CommandImplementationAsync<TCommand> implementation, CancellationToken cancellationToken, object state)
        {
