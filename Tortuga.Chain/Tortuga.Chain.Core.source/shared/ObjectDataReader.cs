...
namespace Tortuga.Chain
{
    ...
    public class ObjectDataReader<TObject> : DbDataReader
    {
        ...
        public override int FieldCount => m_PropertyList.Count();
        ...
        public override object this[string name] => m_PropertyList[m_PropertyLookup[name]].InvokeGet(m_Source.Current);
        ...
        /// <returns>System.Object.</returns>
        public override object this[int ordinal] => m_PropertyList[ordinal].InvokeGet(m_Source.Current);
        ...
        public override IEnumerator GetEnumerator() => m_Source;
        ...
        public override bool Read() => m_Source.MoveNext();
