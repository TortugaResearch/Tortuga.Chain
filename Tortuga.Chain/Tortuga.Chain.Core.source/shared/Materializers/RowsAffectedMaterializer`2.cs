...
//{
//    /// <summary>
//    /// This class indicates the associated operation should be executed without returning a result set, but do fetch the rows affected count.
//    /// </summary>
//    public class RowsAffectedMaterializer<TCommand, TParameter> : Materializer<TCommand, TParameter, int>, ILink<int>
...
//        public RowsAffectedMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder)
//            : base(commandBuilder)
//        { }
