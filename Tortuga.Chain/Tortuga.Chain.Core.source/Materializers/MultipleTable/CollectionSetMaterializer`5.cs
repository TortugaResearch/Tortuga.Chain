...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class CollectionSetMaterializer<TCommand, TParameter, T1, T2, T3> : Materializer<TCommand, TParameter, Tuple<List<T1>, List<T2>, List<T3>>>
        ...
        where T3 : class, new()
    {
        ...
        /// </summary>
        /// <returns></returns>
        public override Tuple<List<T1>, List<T2>, List<T3>> Execute(object state = null)
        {
        ...
        /// <returns></returns>
        public override async Task<Tuple<List<T1>, List<T2>, List<T3>>> ExecuteAsync(CancellationToken cancellationToken, object state = null)
        {
            TableSet result = null;
        ...
        private static Tuple<List<T1>, List<T2>, List<T3>> BuildResult(TableSet result)
        {
            if (result.Count != 3)
                throw new DataException($"Expected 3 tables but received {result.Count} tables");
