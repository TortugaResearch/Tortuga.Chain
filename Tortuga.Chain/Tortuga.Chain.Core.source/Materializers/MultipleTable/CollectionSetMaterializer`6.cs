...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class CollectionSetMaterializer<TCommand, TParameter, T1, T2, T3, T4> : Materializer<TCommand, TParameter, Tuple<List<T1>, List<T2>, List<T3>, List<T4>>>
        ...
        where T4 : class, new()
    {
        ...
        /// </summary>
        /// <returns></returns>
        public override Tuple<List<T1>, List<T2>, List<T3>, List<T4>> Execute(object state = null)
        {
        ...
        /// <returns></returns>
        public override async Task<Tuple<List<T1>, List<T2>, List<T3>, List<T4>>> ExecuteAsync(CancellationToken cancellationToken, object state = null)
        {
            TableSet result = null;
        ...
        private static Tuple<List<T1>, List<T2>, List<T3>, List<T4>> BuildResult(TableSet result)
        {
            if (result.Count != 4)
                throw new DataException($"Expected 4 tables but received {result.Count} tables");
