...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class DateTimeOffsetOrNullMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, DateTimeOffset?> where TCommand : DbCommand
