...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class DateTimeOffsetMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, DateTimeOffset> where TCommand : DbCommand
