...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class Int64ListMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, List<long>> where TCommand : DbCommand
        where TParameter : DbParameter
    {
        ...
        public Int64ListMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string columnName = null, ListOptions listOptions = ListOptions.None)
