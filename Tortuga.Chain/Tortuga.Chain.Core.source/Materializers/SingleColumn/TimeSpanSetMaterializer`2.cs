...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class TimeSpanSetMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, HashSet<TimeSpan>> where TCommand : DbCommand
        where TParameter : DbParameter
    {
        ...
        public TimeSpanSetMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string columnName = null, ListOptions listOptions = ListOptions.None)
        ...
        /// </summary>
        /// <returns></returns>
        public override HashSet<TimeSpan> Execute(object state = null)
        {
        ...
        /// <returns></returns>
        public override async Task<HashSet<TimeSpan>> ExecuteAsync(CancellationToken cancellationToken, object state = null)
        {
            var result = new HashSet<TimeSpan>();
