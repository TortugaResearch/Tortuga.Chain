...
namespace Tortuga.Chain.Materializers
{
    ...
    internal sealed class Int64SetMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, HashSet<long>> where TCommand : DbCommand
        where TParameter : DbParameter
    {
        ...
        /// </summary>
        /// <returns></returns>
        public override HashSet<long> Execute(object state = null)
        {
        ...
        /// <returns></returns>
        public override async Task<HashSet<long>> ExecuteAsync(CancellationToken cancellationToken, object state = null)
        {
            var result = new HashSet<long>();
