...
namespace Tortuga.Chain.PostgreSql
{
	partial class PostgreSqlTransactionalDataSource: Tortuga.Chain.DataSources.ITransactionalDataSource, Tortuga.Chain.DataSources.IOpenDataSource, System.IDisposable
	{
		...
		private Traits.TransactionalDataSourceTrait<Tortuga.Chain.PostgreSqlDataSource, Npgsql.NpgsqlConnection, Npgsql.NpgsqlTransaction, Npgsql.NpgsqlCommand, Tortuga.Chain.PostgreSql.PostgreSqlMetadataCache> ___Trait0 = new();
		private Traits.TransactionalDataSourceTrait<Tortuga.Chain.PostgreSqlDataSource, Npgsql.NpgsqlConnection, Npgsql.NpgsqlTransaction, Npgsql.NpgsqlCommand, Tortuga.Chain.PostgreSql.PostgreSqlMetadataCache> __Trait0
		{
			get
			{
		...
		// Exposing trait Traits.TransactionalDataSourceTrait<Tortuga.Chain.PostgreSqlDataSource, Npgsql.NpgsqlConnection, Npgsql.NpgsqlTransaction, Npgsql.NpgsqlCommand, Tortuga.Chain.PostgreSql.PostgreSqlMetadataCache>
