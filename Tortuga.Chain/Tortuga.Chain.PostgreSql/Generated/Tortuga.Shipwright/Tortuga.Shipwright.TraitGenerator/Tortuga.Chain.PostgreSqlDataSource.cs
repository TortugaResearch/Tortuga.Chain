...
{
	partial class PostgreSqlDataSource: Tortuga.Chain.DataSources.IRootDataSource, Traits.IHasExtensionCache
	{

		private bool __TraitsRegistered;

		// These fields and/or properties hold the traits. They should not be referenced directly.
		private Traits.RootDataSourceTrait<Tortuga.Chain.PostgreSqlDataSource, Tortuga.Chain.PostgreSql.PostgreSqlTransactionalDataSource, Tortuga.Chain.PostgreSql.PostgreSqlOpenDataSource, Npgsql.NpgsqlConnection, Npgsql.NpgsqlTransaction, Npgsql.NpgsqlCommand, Npgsql.NpgsqlConnectionStringBuilder> ___Trait0 = new();
		private Traits.RootDataSourceTrait<Tortuga.Chain.PostgreSqlDataSource, Tortuga.Chain.PostgreSql.PostgreSqlTransactionalDataSource, Tortuga.Chain.PostgreSql.PostgreSqlOpenDataSource, Npgsql.NpgsqlConnection, Npgsql.NpgsqlTransaction, Npgsql.NpgsqlCommand, Npgsql.NpgsqlConnectionStringBuilder> __Trait0
		{
			get
			{
		...
		// Exposing trait Traits.RootDataSourceTrait<Tortuga.Chain.PostgreSqlDataSource, Tortuga.Chain.PostgreSql.PostgreSqlTransactionalDataSource, Tortuga.Chain.PostgreSql.PostgreSqlOpenDataSource, Npgsql.NpgsqlConnection, Npgsql.NpgsqlTransaction, Npgsql.NpgsqlCommand, Npgsql.NpgsqlConnectionStringBuilder>
		...
		public Tortuga.Chain.PostgreSql.PostgreSqlTransactionalDataSource BeginTransaction()
		{
		...
		/// <returns></returns>
		/// <remarks>The caller of this method is responsible for closing the transaction.</remarks>
		public Tortuga.Chain.PostgreSql.PostgreSqlTransactionalDataSource BeginTransaction(System.Nullable<System.Data.IsolationLevel> isolationLevel = default, System.Boolean forwardEvents = true)
		{
		...
		/// <returns></returns>
		/// <remarks>The caller of this method is responsible for closing the transaction.</remarks>
		public System.Threading.Tasks.Task<Tortuga.Chain.PostgreSql.PostgreSqlTransactionalDataSource> BeginTransactionAsync(System.Nullable<System.Data.IsolationLevel> isolationLevel = default, System.Boolean forwardEvents = true, System.Threading.CancellationToken cancellationToken = default)
		{
		...
		/// <returns></returns>
		/// <remarks>The caller of this method is responsible for closing the transaction.</remarks>
		public System.Threading.Tasks.Task<Tortuga.Chain.PostgreSql.PostgreSqlTransactionalDataSource> BeginTransactionAsync()
		{
		...
		/// </remarks>
		public System.Threading.Tasks.Task<Npgsql.NpgsqlConnection> CreateConnectionAsync(System.Threading.CancellationToken cancellationToken = default)
		{
		...
		public Tortuga.Chain.PostgreSql.PostgreSqlOpenDataSource CreateOpenDataSource(Npgsql.NpgsqlConnection connection, Npgsql.NpgsqlTransaction? transaction = default)
		{
		...
		/// </summary>
		private   Npgsql.NpgsqlConnectionStringBuilder m_ConnectionBuilder
		{
		...
		/// <returns></returns>
		public Tortuga.Chain.PostgreSqlDataSource WithCache(Tortuga.Chain.Core.ICacheAdapter cache)
		{
		...
		/// <returns></returns>
		public Tortuga.Chain.PostgreSqlDataSource WithRules(params Tortuga.Chain.AuditRules.AuditRule[] additionalRules)
		{
		...
		/// <param name="additionalRules">The additional rules.</param>
		/// <returns></returns>
		public Tortuga.Chain.PostgreSqlDataSource WithRules(System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule> additionalRules)
		{
			return __Trait0.WithRules(additionalRules);
		}
		...
		/// </remarks>
		public Tortuga.Chain.PostgreSqlDataSource WithUser(System.Object? userValue)
		{
		...
		private partial System.Threading.Tasks.Task<Tortuga.Chain.PostgreSql.PostgreSqlTransactionalDataSource> OnBeginTransactionAsync(System.Nullable<System.Data.IsolationLevel> isolationLevel, System.Boolean forwardEvents, System.Threading.CancellationToken cancellationToken );

		private partial Tortuga.Chain.PostgreSqlDataSource OnCloneWithOverrides(Tortuga.Chain.Core.ICacheAdapter? cache, System.Collections.Generic.IEnumerable<Tortuga.Chain.AuditRules.AuditRule>? additionalRules, System.Object? userValue );

		private partial Npgsql.NpgsqlConnection OnCreateConnection( );

		private partial System.Threading.Tasks.Task<Npgsql.NpgsqlConnection> OnCreateConnectionAsync(System.Threading.CancellationToken cancellationToken );

		private partial Tortuga.Chain.PostgreSql.PostgreSqlOpenDataSource OnCreateOpenDataSource(Npgsql.NpgsqlConnection connection, Npgsql.NpgsqlTransaction? transaction );
