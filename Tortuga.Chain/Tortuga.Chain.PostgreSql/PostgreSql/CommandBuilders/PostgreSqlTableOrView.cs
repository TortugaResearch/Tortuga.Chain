...
/// </summary>
[UseTrait(typeof(SupportsCount64Trait<NpgsqlCommand, NpgsqlParameter, PostgreSqlLimitOption>))]
public partial class PostgreSqlTableOrView<TObject> : TableDbCommandBuilder<NpgsqlCommand, NpgsqlParameter, PostgreSqlLimitOption, TObject>
	where TObject : class
{
