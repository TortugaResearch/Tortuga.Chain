...
namespace Tortuga.Chain.PostgreSql
{
    ...
    public class PostgreSqlMetadataCache : DatabaseMetadataCache<PostgreSqlObjectName, NpgsqlDbType>
    {
        ...
        List<ColumnMetadata<NpgsqlDbType>> GetColumns(PostgreSqlObjectName tableName)
        {
...
WHERE c.relname ILIKE @Name AND
      ns.nspname ILIKE @Schema;";
        ...
        Tuple<List<ParameterMetadata<NpgsqlDbType>>, List<ColumnMetadata<NpgsqlDbType>>> GetParametersAndColumns(string specificName)
        {
            //List<ParameterMetadata<NpgsqlDbType>> GetParameters(string schema, string procedureName)
