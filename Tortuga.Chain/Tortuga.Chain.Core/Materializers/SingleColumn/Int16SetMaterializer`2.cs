...
namespace Tortuga.Chain.Materializers
{
	...
	internal sealed class Int16SetMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, HashSet<short>> where TCommand : DbCommand
		where TParameter : DbParameter
	{
		...
		public Int16SetMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string? columnName = null, ListOptions listOptions = ListOptions.None)
		...
		/// </summary>
		/// <returns></returns>
		public override HashSet<short> Execute(object? state = null)
		{
		...
		/// <returns></returns>
		public override async Task<HashSet<short>> ExecuteAsync(CancellationToken cancellationToken, object? state = null)
		{
			var result = new HashSet<short>();
