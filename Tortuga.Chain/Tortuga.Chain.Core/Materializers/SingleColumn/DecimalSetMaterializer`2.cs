...
namespace Tortuga.Chain.Materializers
{
	...
	internal sealed class DecimalSetMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, HashSet<decimal>> where TCommand : DbCommand
...

	{
		...
		public DecimalSetMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string? columnName = null, ListOptions listOptions = ListOptions.None)
		...
		/// </summary>
		/// <returns></returns>
		public override HashSet<decimal> Execute(object? state = null)
		{
		...
		/// <returns></returns>
		public override async Task<HashSet<decimal>> ExecuteAsync(CancellationToken cancellationToken, object? state = null)
		{
			var result = new HashSet<decimal>();
