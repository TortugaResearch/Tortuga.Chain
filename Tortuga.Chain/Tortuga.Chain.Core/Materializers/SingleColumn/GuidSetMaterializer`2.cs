...
internal sealed class GuidSetMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, HashSet<Guid>> where TCommand : DbCommand
	where TParameter : DbParameter
{
	...
	/// </summary>
	/// <returns></returns>
	public override HashSet<Guid> Execute(object? state = null)
	{
	...
	/// <returns></returns>
	public override async Task<HashSet<Guid>> ExecuteAsync(CancellationToken cancellationToken, object? state = null)
	{
		var result = new HashSet<Guid>();
