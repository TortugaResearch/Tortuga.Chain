...
internal sealed class ByteArrayListMaterializer<TCommand, TParameter> : ListColumnMaterializer<TCommand, TParameter, byte[]>
	...
	where TParameter : DbParameter
{
	...
	public ByteArrayListMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string? columnName = null, ListOptions listOptions = ListOptions.None)
