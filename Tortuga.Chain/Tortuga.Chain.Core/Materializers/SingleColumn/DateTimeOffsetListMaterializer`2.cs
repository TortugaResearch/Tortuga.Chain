...
internal sealed class DateTimeOffsetListMaterializer<TCommand, TParameter> : ListColumnMaterializer<TCommand, TParameter, DateTimeOffset> where TCommand : DbCommand
