...
internal sealed class DateTimeOffsetListMaterializer<TCommand, TParameter> : SingleColumnMaterializer<TCommand, TParameter, List<DateTimeOffset>> where TCommand : DbCommand
