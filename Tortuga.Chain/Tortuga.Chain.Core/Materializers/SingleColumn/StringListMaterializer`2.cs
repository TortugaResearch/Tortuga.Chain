...
internal sealed class StringListMaterializer<TCommand, TParameter> : ListColumnMaterializer<TCommand, TParameter, string> where TCommand : DbCommand
	where TParameter : DbParameter
{
	/// <summary>
	/// Initializes a new instance of the <see cref="StringListMaterializer{TCommand, TParameter}"/> class.
	/// </summary>
