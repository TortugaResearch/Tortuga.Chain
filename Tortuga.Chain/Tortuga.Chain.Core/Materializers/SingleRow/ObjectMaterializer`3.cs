...
namespace Tortuga.Chain.Materializers
{
        ...
        where TObject : class
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Tortuga.Chain.Materializers.ObjectMaterializer{TCommand, TParameter, TObject}"/> class.</summary>
        ...
        /// <exception cref="MappingException">Cannot find a constructor on {desiredType.Name} with the types [{types}]</exception>
