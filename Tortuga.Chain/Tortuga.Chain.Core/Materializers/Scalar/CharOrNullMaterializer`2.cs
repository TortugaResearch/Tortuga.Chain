...
internal sealed class CharOrNullMaterializer<TCommand, TParameter> : ScalarMaterializer<TCommand, TParameter, char?> where TCommand : DbCommand
	where TParameter : DbParameter
{
	...
	public CharOrNullMaterializer(DbCommandBuilder<TCommand, TParameter> commandBuilder, string? columnName = null)
