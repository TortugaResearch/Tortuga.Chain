...
namespace Tortuga.Chain.Materializers
{
	...
	public static class MaterializerUtilities
	{
		...
		internal static StreamingObjectConstructor<T> AsObjectConstructor<T>(this DbDataReader reader, ConstructorMetadata? constructor, IReadOnlyList<ColumnMetadata> nonNullableColumns, bool? populateComplexObject)
			where T : class
		{
			return new StreamingObjectConstructor<T>(reader, constructor, nonNullableColumns, populateComplexObject);
		}

		internal static StreamingObjectConstructor<T> AsObjectConstructor<T>(this DbDataReader reader, IReadOnlyList<Type>? constructorSignature, IReadOnlyList<ColumnMetadata> nonNullableColumns, bool? populateComplexObject)
	where T : class
		{
