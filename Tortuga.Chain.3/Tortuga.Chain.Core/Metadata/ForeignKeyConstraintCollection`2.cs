...
namespace Tortuga.Chain.Metadata
{
    ...
    /// Implements the <see cref="System.Collections.ObjectModel.ReadOnlyCollection{Tortuga.Chain.Metadata.ForeignKeyConstraint{TName, TDbType}}"/>
    /// </summary>
    /// <typeparam name="TName">The type of the name.</typeparam>
    /// <typeparam name="TDbType">The type of the database type.</typeparam>
    /// <seealso cref="System.Collections.ObjectModel.ReadOnlyCollection{Tortuga.Chain.Metadata.ForeignKeyConstraint{TName, TDbType}}" />
