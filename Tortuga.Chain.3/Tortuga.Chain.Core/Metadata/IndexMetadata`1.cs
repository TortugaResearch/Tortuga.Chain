...
namespace Tortuga.Chain.Metadata
{
    ...
    /// <seealso cref="Tortuga.Chain.Metadata.IndexMetadata" />
    public class IndexMetadata<TName, TDbType> : IndexMetadata
        where TDbType : struct
    {
        /// <summary>Initializes a new instance of the <see cref="Tortuga.Chain.Metadata.IndexMetadata`2"/> class.</summary>
