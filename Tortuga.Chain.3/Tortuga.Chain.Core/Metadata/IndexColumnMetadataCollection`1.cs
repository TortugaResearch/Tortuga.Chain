...
{
    /// <summary>Class IndexColumnMetadataCollection.
    /// Implements the <see cref="System.Collections.ObjectModel.ReadOnlyCollection{Tortuga.Chain.Metadata.IndexColumnMetadata{TDbType}}"/></summary>
    /// <typeparam name="TDbType">The database column type.</typeparam>
    /// <seealso cref="System.Collections.ObjectModel.ReadOnlyCollection{Tortuga.Chain.Metadata.IndexColumnMetadata{TDbType}}" />
