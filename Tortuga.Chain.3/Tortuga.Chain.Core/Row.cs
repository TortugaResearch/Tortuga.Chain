...
namespace Tortuga.Chain
{
    ...
    public sealed class Row : IReadOnlyDictionary<string, object?>
    {
        ...
        /// <returns>
        /// true if the object that implements the <see cref="System.Collections.Generic.IReadOnlyDictionary`2" /> interface contains an element that has the specified key; otherwise, false.
        /// </returns>
